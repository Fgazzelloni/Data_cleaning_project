...
##### Randomize experiment divided the group of 30 volunteers into group proportions:
...
- Jerk      ( the rate at which an object's acceleration changes with respect to time, 
              having both magnitude and direction )
- Magnitude ( the maximum positive value of the height of the wave )
